/* 
**  mod_csrf_protector.c -- Apache sample csrf_protector module
**  [Autogenerated via ``apxs -n csrf_protector -g'']
**
**  To play with this sample module first compile it into a
**  DSO file and install it into Apache's modules directory 
**  by running:
**
**    $ apxs -c -i mod_csrf_protector.c
**
**  Then activate it in Apache's httpd.conf file for instance
**  for the URL /csrf_protector in as follows:
**
**    #   httpd.conf
**    LoadModule csrf_protector_module modules/mod_csrf_protector.so
**    <Location /csrf_protector>
**    SetHandler csrf_protector
**    </Location>
**
...
**    $ apachectl restart
**
**  you immediately can request the URL /csrf_protector and watch for the
**  output of this module. This can be achieved for instance via:
**
**    $ lynx -mime_header http://localhost/csrf_protector 
**
